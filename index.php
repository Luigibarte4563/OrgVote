    ...
    <div class="max-w-2xl w-full text-center space-y-8 z-10">
        ...
        <div class="glass-card rounded-3xl p-8 md:p-10 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                ...
                <a href="/VotingSystem/admin/login.php" class="btn-futuristic bg-white/5 hover:bg-white/10 text-slate-200 font-bold py-4 px-6 rounded-xl border border-white/10 flex items-center justify-center gap-2">
